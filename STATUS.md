...
record (`docs/spine/reviews/s27.md`, three axes on the build and again on
the delta from your walk — the tagline's colon and the card's door as a
door; no hard finding, every should-fix landed); the local build at
http://localhost:4526/ serves the branch head. "merge" is the deploy.
