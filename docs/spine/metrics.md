...
|---|---|---|---|---|---|---|
| 1 | Dataset liveness — open source-change flags older than 48 h | 0 | `gh issue list -R OytunOnal/permit-rulebook-data --state open --label source-change --json number,createdAt` | command | 7 | 2026-09-24 |
| 2 | The daily watch finishes — failures in the last 7 runs | 0 (one single-day failure tolerated) | `gh run list -R OytunOnal/permit-rulebook-data --limit 10 --json conclusion,createdAt` | command | 7 | 2026-09-24 |
